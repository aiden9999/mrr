...
<html>
    ...
    <body>
        ...
        <div class="sub02_01 sub03_01">
            <div class="inner">
                <aside class="side_menu">
                	<c:import url="/WEB-INF/view/menu/hconsulting/aside.jsp"/>
                </aside>
                <div class="contents">
                    <section class="contents_tit">
                        <div class="tit">고입컨설팅 학생부관리</div>
                        <div class="txt">Home > 고입컨설팅 > 학생부관리</div>
                    </section>
                    <section class="section01">
                        <img src="/img/sub03/sub03_01/section01.png">
                    </section>
                </div>
            </div>
        </div>
