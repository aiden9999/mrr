...
<html>
        ...
        <div class="sub05_04">
            <div class="inner">
                <aside class="side_menu">
                    <c:import url="/WEB-INF/view/menu/information/aside.jsp"/>
                </aside>
                <div class="contents">
                    ...
                    <section class="section01">
                        <div class="bbs_wrap">
                            ...
                            <c:choose>
                            	<c:when test="${information.size()>0 && information.size()>0 }">
		                            ...
		                            <c:forEach var="t" items="${information }">
			                            <div class="bbs">
                        ...
                        <c:if test="${login.admin == '메인관리자' }">
	                        <div class="write_btn_wrap">
	                            <div class="write_btn" onclick="location.href='/informat/write'">
    ...
    <script>
    	// 페이지 표시
    	$(document).ready(function(){
    		if(${informationPage > 10}){
    			$("#next").css("display", "block");
    		}
    		if(${selectPage > 10}){
    			$("#prev").css("display", "block");
    		}
    		if(${end >= informationPage}){
